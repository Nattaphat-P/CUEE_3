...
<img src="Asset/Sponsor1.png" width="100%">
...
| 5 | ปุ่มระบบ (System Control) | ใช้ Pin 27 ควบคุมการเปิด/ปิดระบบทั้งหมด | LED 1 (Pin 2) จะติดเมื่อระบบพร้อมทำงาน + (LCD “Monitoring” + beep สั้น เพื่อทดสอบ) |

## แต่ละส่วน จะมีเสียงbuzzerต่างกัน และมีการเรียงpiority output ไป lcd (1=สำคัญสุด)
|ระดับPiority|เหตุการณ์|Output Buzzer|Output LED|Output lcd|
|:----:|:----:|:----:|:----:|:----:|
| 1 | ใกล้หน้าจอ | ติ๊ดเร็ว 1 ที | LED 2 ติด | Too Close , Move back pls|
| 2 | หลังงอ | ติ๊ด 2 ที | LED 2 ติด  |  Bad Posture , Sit straight|
| 3 | นั่งนานเกินไป | ติ๊ดยาว | ไม่มีLED | Take a break , 1hr work done|
| 4 | แสงน้อย| ไม่มีเสียง | LED 3 ติด  | Low Light , Check lighting|
...
| Icon | ชื่อ | ลิ้ง |
|:----:|:----:|:----:|
|<img src="Asset/Canva.png" rect width="48"/>| Canva | [จิ้มตรงนี้เลย](https://www.canva.com/design/DAHEXT_p398/ee_kmW8PMvK5iHlWvznw_Q/edit) |
...
|<img src="Asset/Onshape.webp" rect width="48"/>| Onshape (3D) | [จิ้มตรงนี้เลย](https://cad.onshape.com/documents/c8f79d7ed01564a4cec14bf9/w/396719e0328e4afdfa772147/e/2ed5f0de6a59f7741a7d899d) |
